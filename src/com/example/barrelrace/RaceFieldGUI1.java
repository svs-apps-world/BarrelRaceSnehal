...
import com.example.barrelrace.Horse;
import com.example.barrelrace.R;

public class RaceFieldGUI1 extends View implements SensorEventListener{
	...
	public RaceFieldGUI1(Context context) {
		super(context);
        ...
        mGrass = BitmapFactory.decodeResource(getResources(), R.drawable.bk_grass, opts);        
	}
